          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                By accessing and using OneClickTag (&quot;Service&quot;), you accept and
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Permission is granted to temporarily use OneClickTag for personal
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Paid subscriptions may be offered with different features and
                pricing. You will be billed in advance on a recurring and periodic
                basis. Billing cycles are set on a monthly or annual basis,
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                settings. Your cancellation will take effect at the end of the
                current paid term.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
                Refunds are provided on a case-by-case basis. Please contact our
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                are and will remain the exclusive property of OneClickTag and its
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                In no event shall OneClickTag, nor its directors, employees,
