        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 md:p-12">
          ...
          <div className="border-b border-gray-200 pb-8 mb-8">
            ...
            <p className="text-gray-600 text-lg">
              Your privacy is important to us. This Privacy Policy explains how OneClickTag collects,
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside space-y-2 mb-4 text-gray-700 ml-4">
                <li>
                  ...
                  perform services on our behalf, such as payment processing, data analysis, email
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Google API Data Usage</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                OneClickTag's use and transfer of information received from Google APIs adheres to the{' '}
                <a
              ...
              <ul className="list-disc list-inside space-y-2 mb-4 text-gray-700 ml-4">
                <li>Create and manage conversion tracking tags on your behalf</li>
                <li>Sync tracking configurations with your Google accounts</li>
                <li>Provide analytics and reporting on your tracking performance</li>
              </ul>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                your use of the Service. You can instruct your browser to refuse all cookies or to
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <p className="text-gray-700 font-medium">OneClickTag Privacy Team</p>
